...
# to do arithematic operations addition and division
...
"""a=5
b=6
print("The values of a&b before swapping:",a,b)
a,b=b,a
print("The values of a&b after swapping:",a,b)"""
"""
a=5
b=6
temp=a
...
import random
print("Random value between 1 to 100 is:",random.randint(1,100))
...
print("Right-angle trianle in a single line of code")
for i in range(1,6):
    print("*"*i)

#reverrsed right angle triangle
n=4
